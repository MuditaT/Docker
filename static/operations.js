	...
	$.when(
		...
		{   			
	    	...
	    	$.each(statsData, function(id, stats) 
	    	{
				...
				if(cpuPercent>0.21)
				{
					alertCode=""+cont_id+"exceeds CPU threshold 0.21";
					document.getElementById('alert_info').empty().append(alertCode);
				}
		    ...
		    if(memPercent>0.21)
			{
				alertCode=""+cont_id+"exceeds Memory threshold 1.0%";
				document.getElementById('alert_info').append(alertCode);
			}
